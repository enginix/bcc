...
class PerfEventArray(ArrayBase):
    ...
    def open_perf_buffer(self, callback, page_cnt=8, lost_cb=None, wakeup_events=1, stack_user=0, regs_user=0):
        ...
        for i in get_online_cpus():
            self._open_perf_buffer(i, callback, page_cnt, lost_cb, wakeup_events, stack_user, regs_user)

    def _open_perf_buffer(self, cpu, callback, page_cnt, lost_cb, wakeup_events, stack_user, regs_user):
        ...
        opts.stack_user = stack_user
        opts.regs_user = regs_user
